...
export default function RecentProducts () {
  let { addProductToCart  , setCart , cart , getCart } = useContext(UcartContext)
    ...
    <>
      <div className=' md:mt-10 flex flex-wrap  px-4 py-8 items-center'>
        {data?.data?.data?.map(product => (
          <>
            <div className='group sm:w-1/2   md:w-1/4     lg:w-1/6 px-3 py-4  flex flex-col  justify-center itemsc'>
              <Link
